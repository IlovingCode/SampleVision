...
class ArViewerViewManager : SimpleViewManager<ArViewerView>() {
  ...
  companion object {
    ...
    const val COMMAND_PLANE_ORIENTATION = 4
    const val COMMAND_LOAD_AR_IMAGE = 5
  }
  ...
  override fun getCommandsMap(): Map<String, Int>? {
    return MapBuilder.of(
      ...
      "setPlaneOrientation", COMMAND_PLANE_ORIENTATION,
      "loadArImage", COMMAND_LOAD_AR_IMAGE,
    )
  }
  ...
  override fun receiveCommand(view: ArViewerView, commandId: Int, @Nullable args: ReadableArray?) {
    ...
    when (commandId) {
      ...
      COMMAND_PLANE_ORIENTATION -> {
        if (args != null) {
          view.setPlaneDetection(args.getString(0))
        }
      }
      COMMAND_LOAD_AR_IMAGE -> {
        if (args != null) {
